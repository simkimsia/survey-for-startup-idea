...
<body>
    ...
    <div class="container">
        ...
        <p>Pay $0.01 and you get to use ClickBuyPay <span style="text-decoration:underline; color:red; font-weight: bold">FOR FREE LIFETIME ACCESS</span> when we launch.</p>
